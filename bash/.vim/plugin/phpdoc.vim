...
if g:phpdoc_DefineAutoCommands
    augroup phpdoc
        autocmd BufEnter *.php noremap <F3> :call PHPDOC_DecideClassOrFunc()<CR>
        autocmd BufEnter *.php noremap <F4> :call PHPDOC_ClassVar()<CR>
        autocmd BufLeave *.php unmap <F3>
        autocmd BufLeave *.php unmap <F4>
    augroup END
